...
REPORTDIR=/home/oracle/mii/$3/awrgrpt
...
DECLARE
   ...
   v_reporttype  CONSTANT VARCHAR2(5) := 'html' ;
...
BEGIN
   ...
   FOR c_recsnid IN c_snid LOOP
      ...
      v_reportname := '$REPORTDIR/'||'awr'||c_recsnid.snap_id|| 
      ...
      dbms_output.put_line('@$ORACLE_HOME/rdbms/admin/awrgrpt');
